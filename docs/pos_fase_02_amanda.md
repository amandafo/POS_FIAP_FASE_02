...
![Docker Compose PS](imagens/parte_local_comprovacao_docker_compose_ps.png)

### Evidencia - Health checks locais

![Health checks Docker Compose](imagens/parte_local_comprovacao_docker_compose_health_check.png)
...
![Teste local automatizado 1](imagens/parte_local_comprovacao_docker_testes_automazidos_1.png)

![Teste local automatizado 2](imagens/parte_local_comprovacao_docker_testes_automazidos_2.png)

![Teste local automatizado 3](imagens/parte_local_comprovacao_docker_testes_automazidos_3.png)
...
![EKS Cluster Ativo](imagens/partes_aws_comprovacao_eks_cluster_ativo.png)

### Evidencia - Computacao do cluster

![EKS Computacao](imagens/partes_aws_comprovacao_eks_cluster_ativo_computacao.png)

### Evidencia - Kubernetes no Console

![EKS Kubernetes](imagens/partes_aws_comprovacao_eks_cluster_ativo_computacao_kube.png)

### Evidencia - Redes do cluster

![EKS Redes](imagens/partes_aws_comprovacao_eks_cluster_ativo_redes.png)

### Evidencia - Node Group ativo

![Node Group Ativo](imagens/partes_aws_comprovacao_eks_cluster_node_group_ativo.png)

### Evidencia - Nodes e pods pelo terminal

![kubectl nodes e pods](imagens/partes_aws_comprovacao_terminal_kube_node_and_pods.png)
...
![ECR Repositories](imagens/partes_aws_comprovacao_ecr.png)

### Evidencia - Build e push das imagens

![Build 1](imagens/parte_aws_comprovacao_build_1.png)

![Build 2](imagens/parte_aws_comprovacao_build_2.png)
...
![RDS PostgreSQL](imagens/partes_aws_comprovacao_postgres_rds.png)
...
![ElastiCache Redis](imagens/partes_aws_comprovacao_redis_elastic_cache.png)
...
![DynamoDB](imagens/partes_aws_comprovacao_dynamo.png)

### Evidencia - Detalhes DynamoDB

![DynamoDB Detalhes](imagens/partes_aws_comprovacao_dynamo_detalhes.png)

### Evidencia - Dados no DynamoDB apos os testes

![DynamoDB Dados](imagens/partes_aws_comprovacao_dynamo.png)
...
![SQS](imagens/partes_aws_comprovacao_sqs.png)
...
![Estrutura dos manifests](imagens/parte_aws_manifesto_estruturacao_pastas_locais.png)

### Evidencia - Namespace e Kustomization

![Kustomization](imagens/parte_manifesto_kustomization.png)

### Evidencia - ConfigMap

![ConfigMap](imagens/parte_manifesto_configmap.png)

### Evidencia - Secrets Example

![Secrets Example](imagens/parte_manifesto_secrets_example.png)

### Evidencia - Auth Service

![Auth Service Manifest](imagens/parte_manifesto_auth_service.png)

### Evidencia - Flag Service

![Flag Service Manifest](imagens/parte_manifesto_flag_service.png)

### Evidencia - Targeting Service

![Targeting Service Manifest](imagens/parte_manifesto_targeting_services.png)

### Evidencia - Evaluation Service

![Evaluation Service Manifest](imagens/parte_manifesto_evaluation_service.png)

### Evidencia - Analytics Service

![Analytics Service Manifest](imagens/parte_manifesto_analystics_service.png)
...
![kubectl apply](imagens/parte_aws_comprovacao_terminal_kube_ctl_apply.png)

### Evidencia - Pods e Services

![kubectl get pods e svc](imagens/parte_aws_comprovacao_terminal_kube_ctl.png)
...
![Evaluation HPA](imagens/parte_manifesto_evaluation_hpa.png)

### Evidencia - HPA Analytics Service

![Analytics HPA](imagens/parte_manifesto_analystics_hpa.png)

### Evidencia - HPA em execucao

![Teste HPA](imagens/parte_aws_teste_hpa.png)
...
![Teste E2E](imagens/parte_aws_teste_e2e.png)

### Evidencia - Logs do teste E2E

![Teste E2E Logs](imagens/parte_aws_teste_e2e_logs.png)
