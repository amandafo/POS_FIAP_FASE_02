...
try:
    ...
    sqs_client = session.client("sqs", endpoint_url=os.getenv("AWS_SQS_ENDPOINT_URL"))
    dynamodb_client = session.client("dynamodb", endpoint_url=os.getenv("AWS_DYNAMODB_ENDPOINT_URL"))
